...
const SentryCommitConnecter = (props) => {
  const { connectedSentryInfo, setConnectedSentryInfo } = props;
    ...
    <>
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          ...
          <p className="text-[13px]">Connect Logwise with Sentry commits</p>
          {connectedSentryInfo?.git_commit_status === true ? (
            ...
            <span className="flex justify-start items-center gap-2">
              <span className="flex justify-start items-center gap-1">
                ...
                <span className="text-[13px] text-slate-400">{`on ${getDate(
                  connectedSentryInfo?.git_commit_date
                )}`}</span>
              </span>
            </span>
          </div>
...
export default SentryCommitConnecter;
